...
session_start();
include("../dashboard/include/DatabaseManager.php");
...
<body class="bg-gradient-primary">
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST"){
      ...
      if(empty($username_err) && empty($password_err)){
              ...
              else if($logres == 3)
              {
                      ...
                      $_SESSION["id"] = $id;
                      $_SESSION["simulator"] = $db->get_simulator($id);
                      $_SESSION["username"] = $username;
                      $_SESSION["workingdir"] = $db->get_workingdir($id);
                      error_log("SELECT workingdir from simulators where  iduser=".$_SESSION["workingdir"]);
  ...
  ?>
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex">
                                <div class="flex-grow-1 bg-login-image" style="background-repeat: no-repeat;
                                                                                  background-size: 50%;
                                                                                  background-position: center;background-image: url(&quot;../dashboard/assets/img/dogs/image3.jpeg&quot;);"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
    ...
    <script src="../dashboard/assets/js/greencharge.js"></script>
