...
function input_controller()
{
    ...
    if ($route->format == 'json')
    {
        ...
        */
        ...
        if ($route->action == 'lastvalue') {
        	if(isset($_GET['id']))
        		$result=$input->get_last_value($_GET['id']);
        	else
        		$result="id not set!";
        }
    }
