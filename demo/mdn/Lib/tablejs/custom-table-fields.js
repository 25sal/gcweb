...
var customtablefields = {
          ...
          for (z in processPairs)
          {
            ...
            switch(key)
            {
              ...
              case 33:
                key = '= 0'; type = 3; break;
              case 35:
                key = 'cossmic_sync'; type = 3; break;
              case 36:
                key = 'min feeds';  type = 3; break;
              case 37:
                key = 'p-learn';  type = 3; break;
              case 38:
                key = 'write to inp';  type = 1; break;
              case 39:
                key = 'household';  type = 3; break;
              case 42:
                key = 'l/s to l'; type = 2; break;
              case 43:
                key = 'l/s to ld'; type = 2; break;
	      case 44:
                key = 'l to ld'; type = 2; break;
     ...
     'iconjs':
    {
        'draw': function (row,field) { 
          var icon = 'icon-eye-open'; if (table.fields[field].icon) icon = table.fields[field].icon;
          return "<i onClick="+table.fields[field].link+"('"+table.data[row]['id']+"');   class='"+icon+"' ></i>" 
        }
    },
}
