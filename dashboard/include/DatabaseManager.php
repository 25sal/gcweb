...
class DatabaseManager {
   ...
   public function get_userid($username){
    ...
    $result =  mysqli_query($this->link, 'SELECT id from users where  email="'.$username.'"');
   ...
   public function get_simulator($iduser){

    $result =  mysqli_query($this->link, "SELECT processname from simulators where  iduser=".$iduser);
    $row = mysqli_fetch_assoc($result);
    if(!empty($row["processname"])) return $row["processname"];
    else
        return NULL;
   ...
   public function get_workingdir($iduser){

    $result =  mysqli_query($this->link, "SELECT workingdir from simulators where  iduser=".$iduser);
    $row = mysqli_fetch_assoc($result);
    if(!empty($row["workingdir"])) return $row["workingdir"];
    else
        return NULL;
